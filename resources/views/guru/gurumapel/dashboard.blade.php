...
<main class="flex-1 overflow-y-auto p-6">
    <div class="grid grid-cols-1 lg:grid-cols-4 gap-6">
        <div class="lg:col-span-2 bg-white rounded-xl shadow-lg p-6 animate-fade-in"
            ...
            <div class="space-y-4">
                ...
                <div
                    class="bg-gray-100 rounded-lg p-4 border border-gray-200 flex items-center justify-between">
                    <div class="flex items-center gap-4">
                        <div class="bg-gray-200 p-3 rounded-full text-gray-600">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-6 w-6" viewBox="0 0 24 24"
                                ...
                                stroke-linejoin="round">
                                <path
                                    d="M12 2v20M17 5H9.5a3.5 3.5 0 0 0 0 7H19M12 12v10M5 19h10.5a3.5 3.5 0 0 0 0-7H5" />
                            </svg>
                        </div>
                        <div>
